...
Я 4 года занималась анализом геологических данных. Со временем поняла, что хочу развиваться в аналитике и решила сменить профессию. 

Начала свой путь с Ozon, где занималась исследованиями и ad-hoc аналитикой. Я научилась лучше понимать бизнес и цели поставленных задач. За время работы я стала селлером, что улучшило мою продуктовую экспертизу.

Сейчас я работаю аналитиком данных в СберСпасибо. Основные рабочие задачи - оценка эффектов акций. Эффект оценивается на стат. значимость, поэтому в работе применяю статистику.

Люблю системность и структурированность. Мне нравится не просто делать задачу, а понимать как решение поможет бизнесу, а также как формируются оцениваемые метрики и что на них влияет.

В свободное время занимаюсь спортом, читаю хабр, хожу на meetup
...
### Связаться со мной: 
  ...
  <a href="https://t.me/ekaterzhuravleva">
