...
### :woman_technologist: Привет! Меня зовут Катя 
  ...
  В июле 20234 я вышла на стажировку в Ozon на позиции аналитик, где исследую инциденты, которые влияют на опыт продавца или покупателя.

Мои обязанности:
1. Формирование и выполнение ad-hoc запросов;
2. Анализ бизнес-процессов для выявления причин возникновения проблемных заказов;
3. Общение с владельцами бизнес-процессов, составление плана устранения проблемы, составление регламентов
4. Оценка влияния инцидента на бизнес

Достижения:
1) Написала скрип для автоматизированного мониторинга и пушинга ответственных при появлении несогласованных процессов;
2) В результате анализа бизнес процессов сократила объём проблемных заказов;
3) Выявила неработающие процессы, из-за которых теряется GMV, растёт контактность;
4) Выявила процессы, в которых некорректно обрабатывают проблемные заказы, что приводит к потере GMV, росту контактности, затрат на логистику;
