...
### :woman_technologist: Привет! Меня зовут Катя 
  ...
  Сейчас я стажируюсь в Ozon на позиции аналитик, занимаюсь анализом инцидентов.

  Мои основные задачи: 
  1. Формирование тех. задания для поиска данных о пострадавших в инциденте заказ, клиентах  и др. участников;
  2. Анализ данных и оценка влияния инцидента на бизнес;
  3. Анализ данных по проблемным заказам;
  4. Анализ бизнес-процессов для выявления причин возникновения проблемных заказов;
  5. Общение с владельцами бизнес-процессов, составление плана устранения проблемы, составление регламентов
